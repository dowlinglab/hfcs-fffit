...
def main():
    ...
    fig.savefig("fig3_r125-top10-radar.pdf")
    ...
    fig.savefig("fig3_r125-top10-vals-radar.pdf")
    ...
    fig.savefig("fig3_r125-rand5-radar.pdf")
    ...
    fig.savefig("fig3_r125-all-radar.pdf")
